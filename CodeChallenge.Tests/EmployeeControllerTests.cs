...
namespace CodeCodeChallenge.Tests.Integration
{
    ...
    public class EmployeeControllerTests
    {
        ...
        public void GetReportStructureById_Returns_Ok()
        {
            ...
            // Execute
            var getRequestTask = _httpClient.GetAsync($"api/employee/reportStructure/{employeeId}");
            var response = getRequestTask.Result;
        ...
        public void CreateCompensation_Returns_Created()
        {
            ...
            var compensation = new Compensation()
            {
                ...
                {
                    EmployeeId = "21a786ae-ed73-4567-34fe-c423658245af",
                    Department = "Money",
                    FirstName = "Salt",
                    LastName = "Jones",
                    Position = "Boss"
                ...
                Salary = 35000,
                EffectiveDate = System.DateTime.Parse("1998-05-22")
            };
        ...
        {
            // Arrange
            var expectedCompensationId = "21a786ae-ed73-4567-34fe-c423658245af";
            var expectedSalary = 35000;
            var expectedEffectiveDate = System.DateTime.Parse("1998-05-22");

            // Execute
            var getRequestTask = _httpClient.GetAsync($"api/employee/compensation/{expectedCompensationId}");
            var response = getRequestTask.Result;
